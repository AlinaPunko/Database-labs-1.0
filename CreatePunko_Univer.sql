use master 
go
create database PUNKO_UNIVER
on primary
(name =N'PUNKO_UNIVER_mdf', filename=N'D:\BD\PUNKO_UNIVER_mdf.mdf',
size = 5120Kb, maxsize=10240Kb,filegrowth=1024Kb),
(name =N'PUNKO_UNIVER_ndf', filename=N'D:\BD\PUNKO_UNIVER_ndf.ndf',
size = 5120Kb, maxsize=10240Kb,filegrowth=10%),
filegroup G1
(name =N'PUNKO_UNIVER11_ndf', filename=N'D:\BD\PUNKO_UNIVER11_ndf.ndf',
size = 10240Kb, maxsize=15Mb,filegrowth=1024Kb),
(name =N'PUNKO_UNIVER12_ndf', filename=N'D:\BD\PUNKO_UNIVER12_ndf.ndf',
size = 2Mb, maxsize=5Mb,filegrowth=1024Kb),
filegroup G2
(name =N'PUNKO_UNIVER21_ndf', filename=N'D:\BD\PUNKO_UNIVER21_ndf.ndf',
size = 5Mb, maxsize=10Mb,filegrowth=1024Kb),
(name =N'PUNKO_UNIVER22_ndf', filename=N'D:\BD\PUNKO_UNIVER22_ndf.ndf',
size = 2Mb, maxsize=5Mb,filegrowth=1024Kb)
log on
(name =N'PUNKO_UNIVER_log', filename=N'D:\BD\PUNKO_UNIVER.ldf',
