...
USE Master
--CREATE database ТМРPUNKO_UNIVER ;
USE ТМРPUNKO_UNIVER ;
GO 
...
------Создание и заполнение таблицы PROFESSION
 ...
 insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME, QUALIFICATION)    values    ('ИДиП',  '1-40 01 02',   'Информационные системы и техно-логии', 'инженер-программист-системотехник' );
 ...
 insert into PROFESSION(FACULTY, PROFESSION,  PROFESSION_NAME, QUALIFICATION)   values    ('ЛХФ',  '1-75 02 01',   'Садово-парковое строительство', 'ин-женер садово-паркового строительства' );
 ...
 insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME, QUALIFICATION)  values    ('ИЭФ',  '1-25 01 07',  'Экономика и управление на предприя-тии', 'экономист-менеджер' );
 ...
 insert into PROFESSION(FACULTY, PROFESSION,     PROFESSION_NAME, QUALIFICATION)  values    ('ТТЛП',  '1-36 05 01',   'Машины и оборудование лесно-го комплекса', 'инженер-механик' );
 ...
 insert into PROFESSION(FACULTY, PROFESSION,     PROFESSION_NAME, QUALIFICATION)      values    ('ТОВ',  '1-48 01 02',  'Химическая технология орга-нических веществ, материалов и изделий', 'инженер-химик-технолог' );                
